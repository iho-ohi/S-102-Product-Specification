...
The root bounding box must include the entire data coverage of the S-102 product. This includes the outermost cell boundaries of the data and nodata grid cells and the bounding box / domainExtent.polygon of each feature instance group.
