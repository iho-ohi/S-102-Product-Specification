...
The attribute _low_ shall be the minimum coordinate values for each coordinate axis among all grid cells within the envelope. For this specification the value is the southwest corner coordinate of the southwesternmost grid cell.
...
.S-102 grid structure. Grid cells are the sample space of grid points.
