...
|0..1
|Boolean
|See <<subsec-s102-replacedData-dataReplacement-note1>> +
...
|===
[[subsec-s102-replacedData-dataReplacement-note1]]
[NOTE]
====
_replacedData_ and _dataReplacement_: The intended use of the attributes _replacedData_ and _dataReplacement_ could be, for example, to provide a mechanism for service providers to build automation when providing replacement datasets to customers within existing subscription periods.
====
