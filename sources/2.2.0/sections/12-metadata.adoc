...
See S100_Purpose
//replace last line of remarks column above with a proper reference (LH comment 8Feb2023)
...
S-102 uses S100_DigitalSignatureValue without modification. As stated in <<iho-s100,part=15>>:
...
-- IHO S-100 Part 15 Clause X.X

//Probably not the best block quote method, but it will serve at least as a placeholder. (LH comment 8Feb2023)
