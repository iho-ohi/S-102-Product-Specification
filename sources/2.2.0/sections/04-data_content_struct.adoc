...
.Data Set Structure of S-102 (Width)
image::../images/figure-data-set-structure-s102.png[alt="Data Set Structure of S-102", width=100%]

.Data Set Structure of S-102 (ScaleWidth)
image::../images/figure-data-set-structure-s102.png[alt="Data Set Structure of S-102", scaledwidth=100%]

.Data Set Structure of S-102 (Scale)
image::../images/figure-data-set-structure-s102.png[alt="Data Set Structure of S-102", scaledwidth=100vw]

.Data Set Structure of S-102 (Scale CM)
image::../images/figure-data-set-structure-s102.png[alt="Data Set Structure of S-102", pdfwidth=100%,width=100%, scalewidth=16cm]

.Data Set Structure of S-102 (PDF Role)
image::../images/figure-data-set-structure-s102.png[alt="Data Set Structure of S-102", pdfwidth=100%, role=full-width]
