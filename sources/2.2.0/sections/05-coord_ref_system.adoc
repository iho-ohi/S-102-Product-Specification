...
2+|The full reference to EPSG can be found at link:http://www.epsg.org/[www.epsg.org].
|===
...
*Coordinate Reference System registry*:: link:http://www.epsg.org/[EPSG Geodetic Parameter Registry]
