...
* Metadata used for the discovery, identification, and use of {series}-{docnumber} datasets in S-100-based navigations systems (specifically, an S-100-capable ECDIS) is encoded in the exchange catalogue. This metadata conforms to S-100 Part 17, with product-specific restrictions added.
...
{series}-{docnumber} uses S100_ExchangeCatalogue without modification. 
...
*The corresponding Idx-number of the IHO Registry for {series}-{docnumber} Ed. {edition} is 215.*
