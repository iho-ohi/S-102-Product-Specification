...
|April 2012
|TSMAD
|Approved edition of {series}-{docnumber}
...
|February 2018
|{series}-{docnumber}PT
|Modified Clause 9.0. Deleted contents of Annex B in preparation for updated S-100 Part 10C guidance. Added Annex F: {series}-{docnumber} Dataset Size and Production, Annex G: Gridding Example, Annex H: Statement added for Multi-Resolution Gridding, Annex I: Statement for future {series}-{docnumber} Tiling.

|2.0.0
|June 2018
|{series}-{docnumber}PT
|Modifications to align with S-100 v4.0.0, S-100 Part 10c development, and actions from 4^th^ April {series}-{docnumber} Project Team Meeting.
...
|{series}-{docnumber}PT
|Adjudicated HSSC and S102PT Comments at 5^th^ {series}-{docnumber} Project Team Meeting.
...
{series}-{docnumber}PT6-07.1_CHS-Paper to limit the mandate of the {series}-{docnumber} standard for navigation only -- remove track changes and tiling options. +
{series}-{docnumber}PT6_2020_05.c_Data Product Format_Prepared by CARIS-v3.pdf -- adjusted with comments from 7Cs and BSH. +
...
{series}-{docnumber}PT7 agreed in principle to limit the scope of {series}-{docnumber} v 2.1 to Navigation Only. Several sections adjusted in view of this decision. +
[[lhh1-start1]]{series}-{docnumber}PT7 revised storage locations for minimum/maximum depth and associated uncertainty. +
{series}-{docnumber}PT7 agreed for metadata to be stored in a separate ISO-formatted file.[[lhh1-end1]] +
...
* Removed provisions for including ISO metadata in {series}-{docnumber} exchange sets +
 +
