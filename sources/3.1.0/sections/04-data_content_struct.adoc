...
In {series}-{docnumber}, _depth_ and _uncertainty_ have been registered as simple attributes, type `<real>`; and _iD_ has been registered as a simple attribute, type `<integer>`. Simple attributes are defined in <<iho-s100,part=5,clause=5-4.2.3.3>>. 
