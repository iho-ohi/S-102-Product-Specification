...
data quality scope *&lt;XXX&gt;* -> must be replaced -> What is this?

Annex *&lt;X&gt;* -> must be replaced -> Is that S-158:102?
--

Commission is applicable for {series}-{docnumber} or the data quality scope [.red]#*&lt;XXX&gt;*# of {series}-{docnumber}.
...
Omission is applicable for {series}-{docnumber} or the data quality scope [.red]#*&lt;XXX&gt;*# of {series}-{docnumber}. 
