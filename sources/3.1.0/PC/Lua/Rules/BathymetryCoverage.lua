...
function BathymetryCoverage(feature, featurePortrayal, contextParameters)
	...
	if contextParameters.FourShades then
		...
		featurePortrayal:AddInstructions('CoverageColor:DEPVS,0;LookupEntry:Shallow Water,0,' .. tostring(contextParameters.SafetyContour) .. ',geLtInterval;CoverageFill:depth')
